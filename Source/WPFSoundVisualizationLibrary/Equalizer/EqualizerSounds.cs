...
namespace WPFSoundVisualizationLib
{
    ...
    /// </summary>
    public class EqualizerSounds : SampleAggregatorBase
    {
        ...
        public EqualizerSounds(ISampleSource source)
            : base(source)
        {
            if (source == null)
        ...
        public static EqualizerSounds Create10BandEqualizer(ISampleSource source)
        {
        ...
        /// </param>
        /// <returns>A new instance of the <see cref="Equalizer" /> class with 10 preset <see cref="EqualizerFilter" />.</returns>
        public static EqualizerSounds Create10BandEqualizer(ISampleSource source, int bandWidth, int defaultGain)
        {
            ...
            var equalizer = new EqualizerSounds(source);
